...
public class CalendarController implements Initializable {
    ...
    public void construct(SchedulerDAL _sdal) throws SQLException
    {
        ...
        //Load customers into tableview
            ...
            calendarTableView.itemsProperty().bind(apptProperty);
        ...
        ZonedDateTime firstOfWeek = now.with(ChronoField.DAY_OF_WEEK,1);    //First day of the week
    ...
    private void setCalendarView()
    {
        ...
        calendarTableView.itemsProperty().set(newAppoints);
